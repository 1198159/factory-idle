    ...
    <div id="gameArea">
        ...
        <script type="text/javascript">
            ...
            window.onerror = function (msg, url, lineNo, columnNo, error) {
                GAME_LOADED = true;
                document.getElementById("loadingMessage").innerHTML = "<b class='red'>Error loading the game.</b><br /> Please try again and if still happens, contact Alex Stedman: <br />" +
                "<br />" +
